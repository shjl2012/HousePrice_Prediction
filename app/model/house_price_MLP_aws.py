...
class HousePriceModel_aws:
    ...
    def __init__(self, c):
        self.cityname = c
        self.modelpath = f'./model/{self.cityname}/model_mlp_aws.pkl'
    ...
    def trainModel(self):
        ...
        joblib.dump(model_mlp, f'./model/{self.cityname}/model_mlp_aws.pkl')
    ...
    def testModel(self, testfile):
        if os.path.isfile(self.modelpath):
            ...
            model_mlp = joblib.load(f'./model/{self.cityname}/model_mlp_aws.pkl')
